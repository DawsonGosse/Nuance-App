...
export default function Rankings() {
  ...
  return <Container>
    ...
    <ButtonCont>
        ...
        {(CheckState.disagree === true && questionprompts === 'Universal Basic Income could solve poverty') && <ButtonUI text="DIREP4" routeTo='/agree/Universal Basic Income could solve poverty'></ButtonUI>}
