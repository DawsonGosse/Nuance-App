...
export default function CategoriesPage() {
  ...
  return <Container>
    ...
    <RowCont>
        ...
        <TopicButtonUI bannertext="violent crimes" src="/Topic5.png" inactive='grayscale(100%)' text='#585858'></TopicButtonUI>
        <TopicButtonUI bannertext="foreign policy" src="/Topic6.png" onClick={()=>router.push('/topic/foreign-policy')}></TopicButtonUI>
        <TopicButtonUI bannertext="gun policy" src="/Topic7.png" inactive='grayscale(100%)' text='#585858'></TopicButtonUI>
        <TopicButtonUI bannertext="ethnic & race" src="/Topic8.png" inactive='grayscale(100%)' text='#585858'></TopicButtonUI>
        ...
        <TopicButtonUI bannertext="abortion" src="/Topic11.png" inactive='grayscale(100%)' text='#585858'></TopicButtonUI>
        <TopicButtonUI bannertext="other" inactive='grayscale(100%)' text='#585858'></TopicButtonUI>
