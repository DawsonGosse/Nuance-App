...
export default function Rankings() {
  ...
  return <Container>
    ...
    <ButtonCont>
        {(CheckState.agree === true && questionprompt === 'Electric vehicles are a better option') && <ButtonUI text="AREE"></ButtonUI>}
        {(CheckState.disagree === true && questionprompt === 'Electric vehicles are a better option') && <ButtonUI text="DIREP"></ButtonUI>}
        {(CheckState.agree === true && questionprompt === 'Countries should have open borders') && <ButtonUI text="AREE"></ButtonUI>}
        {(CheckState.disagree === true && questionprompt === 'Countries should have open borders') && <ButtonUI text="DIREP"></ButtonUI>}
        {(CheckState.agree === true && questionprompt === 'COVID lock-downs are necessary and beneficial') && <ButtonUI text="AREE"></ButtonUI>}
        {(CheckState.disagree === true && questionprompt === 'COVID lock-downs are necessary and beneficial') && <ButtonUI text="DIREP"></ButtonUI>}
        {(CheckState.agree === true && questionprompt === 'Universal Basic Income could solve poverty') && <ButtonUI text="AREE"></ButtonUI>}
