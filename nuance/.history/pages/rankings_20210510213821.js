...
export default function Rankings() {
  ...
  return <Container>
    ...
    <ButtonCont>
        ...
        {(CheckState.disagree === true && questionprompts === 'COVID lock-downs are necessary and beneficial') && <ButtonUI text="DIREP3" routeTo='/agree/Electric vehicles are a better option'></ButtonUI>}
