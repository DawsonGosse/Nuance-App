...
export default function CategoriesPage() {
  return <Container>
    ...
    {obj.catClimatechange === false && <TopicHeaderUI bannertext="Climate Change"></TopicHeaderUI>}
    {obj.catEconomy === false && <TopicHeaderUI bannertext="Economy" src='/Topic1Large.png'></TopicHeaderUI>}
