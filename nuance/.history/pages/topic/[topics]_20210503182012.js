...
export default function Topics() {
    ...
    const [qvisiblity, SetQVisibility] = useState(false)
    ...
    if(topics === 'healthcare')
    {
        ...
        questiontext.question2.style.display = 'none'
    ...
    if(questiontext.question1 === '' || questiontext.question2 === '' || questiontext.question3 === '' || questiontext.question4 === '')
    {
        SetQVisibility(true)
    }
  ...
  return <Container>
    ...
    {questiontext.question2 === !true && <QuestionButton text={questiontext.question2}></QuestionButton>}
    {questiontext.question3 === !true && <QuestionButton text={questiontext.question3}></QuestionButton>}
    {questiontext.question4 === !true && <QuestionButton text={questiontext.question4}></QuestionButton>}
    <Line></Line>
