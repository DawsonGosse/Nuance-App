...
export default function Topics() {
    ...
    {questiontext.question3 !== 'null' && <QuestionButton text={questiontext.question3} routeTo={routing.path2}></QuestionButton>}
    {questiontext.question4 !== 'null' && <QuestionButton text={questiontext.question4} routeTo={routing.path3}></QuestionButton>}
    <Line></Line>
