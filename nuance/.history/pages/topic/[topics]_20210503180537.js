...
export default function Topics() {
  ...
  return <Container>
    ...
    {questiontext.question3 === 'null' && <QuestionButton text={questiontext.question2}></QuestionButton>}
    {questiontext.question4 === 'null' && <QuestionButton text={questiontext.question2}></QuestionButton>}
    <Line></Line>
