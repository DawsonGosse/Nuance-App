...
export default function Topics() {
    ...
    if(topics === 'economy')
    {
        ...
        routing.path2 = '/questionprompt/Electric vehicles are a better option'
        routing.path3 = '/questionprompt/Electric vehicles are a better option'
        routing.path4 = '/questionprompt/Electric vehicles are a better option'
    }
