...
export default function Topics() {
    ...
    if(topics === 'healthcare')
    {
        ...
        routing.path1 = '/COVID lock-downs are necessary and beneficial'
    }
    ...
    if(topics === 'foreign-policy')
    {
        ...
        routing.path1 = '/Countries should have open borders'
    }
    ...
    if(topics === 'climate-change')
    {
        ...
        routing.path1 = '/Electric vehicles are a better option'
    }
