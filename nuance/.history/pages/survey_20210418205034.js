...
export default function SurveyPage() {
  ...
  return <Container>
    ...
    <RowCont>
        <TopicButtonUI bannertext="Economy" src="/Topic1.png" onClick={HandleClickButtonColor} bgcolor={buttonstate ? '#8BB09C' : '#3E3D46'}></TopicButtonUI>
        <TopicButtonUI bannertext="HealthCare" src="/Topic2.png" onClick={HandleClickButtonColor} bgcolor={buttonstate ? '#8BB09C' : '#3E3D46'}></TopicButtonUI>
