...
export default function ForYou() {
  ...
  return <Container>
    ...
    <TopicContainer>
      ...
      {obj.Health === true && <PromptCardUI headertext='Covid-19' bodytext='COVID lock-down mandates are necessary and beneficial.' src='/ForYouPromptCOVID.png'></PromptCardUI>}
