...
export default function Rankings() {
  ...
  return <Container>
    ...
    <ButtonCont>
        ...
        {(CheckState.disagree === true && questionprompts === 'COVID lock-downs are necessary and beneficial') && <ButtonUI text="DIREP3" routeTo='/disagree/COVID lock-downs are necessary and beneficial'></ButtonUI>}
        {(CheckState.agree === true && questionprompts === 'Universal Basic Income could solve poverty') && <ButtonUI text="AREE4" routeTo='/agree/Electric vehicles are a better option'></ButtonUI>}
