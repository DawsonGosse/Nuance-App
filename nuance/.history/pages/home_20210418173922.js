...
export default function HomePage() {
  ...
  return <Container>
    <BannerUI></BannerUI>
    <QuestionCardUI headertext={"Topic "+<text+" day"} bodytext="General Motors has joined a list of growing companies to mandate that all their vehicles be electric by a certain date. Governments too, motivated 
