...
export default function Rankings() {
  ...
  return <Container>
    ...
    <ButtonCont>
        {(CheckState.agree === true && questionprompts === 'Electric vehicles are a better option') && <ButtonUI text="AREE1" routeTo='/agree/Electric vehicles are a better option'></ButtonUI>}
        {(CheckState.disagree === true && questionprompts === 'Electric vehicles are a better option') && <ButtonUI text="DIREP1" routeTo='/disagree/Electric vehicles are a better option'></ButtonUI>}
        {(CheckState.agree === true && questionprompts === 'Countries should have open borders') && <ButtonUI text="AREE2"></ButtonUI>}
        {(CheckState.disagree === true && questionprompts === 'Countries should have open borders') && <ButtonUI text="DIREP2"></ButtonUI>}
        {(CheckState.agree === true && questionprompts === 'COVID lock-downs are necessary and beneficial') && <ButtonUI text="AREE3"></ButtonUI>}
