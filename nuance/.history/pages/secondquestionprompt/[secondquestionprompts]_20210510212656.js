...
export default function SecondQuestionPrompts() {
    ...
    <ImgCont>
        ...
        <ButtonAUI top='320px' left="20px" text="AGREE" onClick='/rankings' ></ButtonAUI>
        <ButtonAUI top='320px' left="218px" text="DISAGREE" onClick='/rankings'></ButtonAUI>
        <ButtonAUI top='400px' left="120px" text="UNSURE" onClick='/rankings'></ButtonAUI>
