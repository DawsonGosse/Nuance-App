...
export default function SecondQuestionPrompts() {
    ...
    if(secondquestionprompts === 'Universal Basic Income could solve poverty')
    {
        ...
        secondquestionpromptdata.questionimg = '/CarImage1.png'
        secondquestionpromptdata.agreesrc = '/disagree/Universal Basic Income could solve poverty'
        secondquestionpromptdata.disagreesrc = '/agree/Universal Basic Income could solve poverty'
    }
  ...
  return <Container>
    ...
    <ImgCont>
        ...
        <ButtonAUI left="20px" text="AGREE" routeTo={secondquestionpromptdata.disagreesrc}></ButtonAUI>
