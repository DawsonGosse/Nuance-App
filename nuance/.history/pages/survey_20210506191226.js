...
export default function SurveyPage() {
  ...
  return <Container>
    ...
    <RowCont>
        ...
        <TopicButtonUI bannertext="GENDER" src="/Topic3.png" inactive='grayscale(100%)' text='#999999' inactivetext="block" onClick={HandleClickButtonColor3} bgcolor={buttonstate3 ? '#8BB09C' : '#3E3D46'}></TopicButtonUI>
