 ...
 const router = useRouter();
  return <Container>
    ...
    <TopicContainer>
      ...
      {obj.Climatechange === true && <PromptCardUI headertext='Climate Change' bodytext='Electric vehicles are a better option.' src='/ForYouPromptCLIMATE.png' onClick={()=>router.push('/questionprompt/COVID lock-downs are necessary and beneficial')}></PromptCardUI>}
    </TopicContainer>
