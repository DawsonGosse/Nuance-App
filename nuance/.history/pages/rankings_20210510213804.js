...
export default function Rankings() {
  ...
  return <Container>
    ...
    <ButtonCont>
        ...
        {(CheckState.disagree === true && questionprompts === 'Countries should have open borders') && <ButtonUI text="DIREP2" routeTo='/disagree/Countries should have open borders'></ButtonUI>}
