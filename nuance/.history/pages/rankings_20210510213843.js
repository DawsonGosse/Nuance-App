...
export default function Rankings() {
  ...
  return <Container>
    ...
    <ButtonCont>
        ...
        {(CheckState.agree === true && questionprompts === 'Countries should have open borders') && <ButtonUI text="AREE2" routeTo='/disagree/Countries should have open borders'></ButtonUI>}
        {(CheckState.disagree === true && questionprompts === 'Countries should have open borders') && <ButtonUI text="DIREP2" routeTo='/agree/Countries should have open borders'></ButtonUI>}
        {(CheckState.agree === true && questionprompts === 'COVID lock-downs are necessary and beneficial') && <ButtonUI text="AREE3" routeTo='/disagree/COVID lock-downs are necessary and beneficial'></ButtonUI>}
        {(CheckState.disagree === true && questionprompts === 'COVID lock-downs are necessary and beneficial') && <ButtonUI text="DIREP3" routeTo='/agree/COVID lock-downs are necessary and beneficial'></ButtonUI>}
        {(CheckState.agree === true && questionprompts === 'Universal Basic Income could solve poverty') && <ButtonUI text="AREE4" routeTo='/disagree/Universal Basic Income could solve poverty'></ButtonUI>}
        {(CheckState.disagree === true && questionprompts === 'Universal Basic Income could solve poverty') && <ButtonUI text="DIREP4" routeTo='/disagree/Universal Basic Income could solve poverty'></ButtonUI>}
