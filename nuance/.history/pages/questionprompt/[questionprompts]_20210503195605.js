...
export default function QuestionPrompts() {
  ...
  return <Container>
    ...
    <ImgCont>
        ...
        <ButtonAUI left="20px" text="AGREE" routeTo={questionpromptdata.diaagreesrc}></ButtonAUI>
        <ButtonAUI left="218px" text="DISAGREE" routeTo={questionpromptdata.disagreesrc}></ButtonAUI>
