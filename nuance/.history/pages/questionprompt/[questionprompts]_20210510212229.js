...
export default function QuestionPrompts() {
    ...
    function HandleDisagree()
    {
        ...
        sessionStorage.setItem('CheckState', JSON.stringify(CheckState))
        sessionStorage.setItem('questionprompts', JSON.stringify(CheckState))
    }
  ...
  return <Container>
    ...
    <ImgCont>
        ...
        <ButtonAUI left="20px" text="AGREE" onClick={HandleAgree}></ButtonAUI>
        <ButtonAUI left="218px" text="DISAGREE" onClick={HandleDisagree}></ButtonAUI>
