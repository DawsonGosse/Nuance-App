...
export default function QuestionPrompts() {
  ...
  return <Container>
    ...
    <ImgCont>
        ...
        <ButtonAUI left="20px" text="AGREE" routeTo={questionpromptdata.disagreesrc} onClick={HandleAgree}></ButtonAUI>
        <ButtonAUI left="218px" text="DISAGREE" routeTo={questionpromptdata.agreesrc} onClick={HandleDisagree}></ButtonAUI>
