...
export default function QuestionPrompts() {
    ...
    if(questionprompts === 'COVID lock-down mandates are necessary and beneficial')
    {
        questionpromptdata.questiontext ='COVID lock-downs mandates are necessary and beneficial'
        questionpromptdata.questionimg = '/CarImage1.png'
    }
